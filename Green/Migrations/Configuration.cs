    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Green.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(Green.Models.ApplicationDbContext context)
        {
            ...
            context.Restaurants.AddOrUpdate(
              f => f.Name,
                new Restaurant { id = Guid.NewGuid().ToString(), OwnerId = context.Users.FirstOrDefault(u => u.UserName.CompareTo("founder@gmail.com") == 0).Id, Name = "Panemar", Address = "Dorobantilor Street, Nr. 30", City="Cluj-Napoca", Type = RestaurantType.Backery, SeatsAvailable = 10, OpeningHour = 10, ClosingHour = 22 },
                new Restaurant { id = Guid.NewGuid().ToString(), OwnerId = context.Users.FirstOrDefault(u => u.UserName.CompareTo("founder@gmail.com") == 0).Id, Name = "Samsara", Address = "Roth Stephan Ludwig Street, Nr. 5", City = "Bucuresti", Type = RestaurantType.Vegan, SeatsAvailable = 20, OpeningHour = 15, ClosingHour = 20 },
                new Restaurant { id = Guid.NewGuid().ToString(), OwnerId = context.Users.FirstOrDefault(u => u.UserName.CompareTo("founder2@gmail.com") == 0).Id, Name = "Tokyo", Address = "Marinescu Gheorghe Street, Nr. 5", City="Turda", Type = RestaurantType.Traditional, SeatsAvailable = 15, OpeningHour = 8, ClosingHour = 21 },
                new Restaurant { id = Guid.NewGuid().ToString(), OwnerId = context.Users.FirstOrDefault(u => u.UserName.CompareTo("founder@gmail.com") == 0).Id, Name = "KFC", Address = "Iuliu Maniu Street, Nr. 1",City="Bistrita", Type = RestaurantType.FastFood, SeatsAvailable = 30, OpeningHour = 11, ClosingHour = 22 },
                new Restaurant { id = Guid.NewGuid().ToString(), OwnerId = context.Users.FirstOrDefault(u => u.UserName.CompareTo("founder2@gmail.com") == 0).Id, Name = "Baracca", Address = "Napoca Street, Nr. 8A", City = "Cluj-Napoca", Type = RestaurantType.Traditional, SeatsAvailable = 29, OpeningHour = 12, ClosingHour = 23 },
                new Restaurant { id = Guid.NewGuid().ToString(), OwnerId = context.Users.FirstOrDefault(u => u.UserName.CompareTo("founder2@gmail.com") == 0).Id, Name = "Nuka Bistro", Address = "Episcop Ioan Bob Street, Nr. 9", City = "Sibiu", Type = RestaurantType.Vegan, SeatsAvailable = 40, OpeningHour = 13, ClosingHour = 22 },
                new Restaurant { id = Guid.NewGuid().ToString(), OwnerId = context.Users.FirstOrDefault(u => u.UserName.CompareTo("founder@gmail.com") == 0).Id, Name = "Indigo", Address = "Piezisa Street, Nr. 10-12", City="Cluj-Napoca", Type = RestaurantType.Traditional, SeatsAvailable = 50, OpeningHour = 9, ClosingHour = 23 },
                new Restaurant { id = Guid.NewGuid().ToString(), OwnerId = context.Users.FirstOrDefault(u => u.UserName.CompareTo("founder@gmail.com") == 0).Id, Name = "Pralina", Address = "Mihai Viteazul Street, Nr. 104", City = "Sibiu", Type = RestaurantType.Pastry, SeatsAvailable = 12, OpeningHour = 8, ClosingHour = 20 },
                new Restaurant { id = Guid.NewGuid().ToString(), OwnerId = context.Users.FirstOrDefault(u => u.UserName.CompareTo("founder2@gmail.com") == 0).Id, Name = "Verde", Address = "George Cosbuc Street, Nr. 9", City = "Iasi", Type = RestaurantType.Vegetarian, SeatsAvailable = 22, OpeningHour = 7, ClosingHour = 22 }
            );
            context.SaveChanges();
